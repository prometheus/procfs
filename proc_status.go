...
type ProcStatus struct {
	...
	Cpus_allowed               string `proc_status:"Cpus_allowed"`
	Cpus_allowed_list          string `proc_status:"Cpus_allowed_list"`
	Mems_allowed               string `proc_status:"Mems_allowed"`
	Mems_allowed_list          string `proc_status:"Mems_allowed_list"`
	Voluntary_ctxt_switches    string `proc_status:"voluntary_ctxt_switches"`
	Nonvoluntary_ctxt_switches string `proc_status:"nonvoluntary_ctxt_switches"`
