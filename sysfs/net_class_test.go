	...
	netClass := NetClass{
		"bond0": {
			...
			BondAttrs: &NetClassBondAttrs{
				...
				Mode:                                   strPTR("802.3ad"),
				ModeID:                                 util.NewValueParser("4").PUInt64(),
				...
				PrimaryReselectID:                      util.NewValueParser("0").PUInt64(),
				...
				TransmitHashPolicyID:                   util.NewValueParser("1").PUInt64(),
			},
		},
		"eth0": {
